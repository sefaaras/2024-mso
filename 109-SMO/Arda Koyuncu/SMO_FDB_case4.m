function [bestSolution, bestFitness, iteration]=SMO_FDB_case4(fhd, dimension, maxIteration, fNumber)
...
%% Starling position
FDBpos = fitnessDistanceBalance(Pop(1:FlockNum, :), Val(1:FlockNum))';
[~,sorted_index] = sort(Val,FDBpos);
