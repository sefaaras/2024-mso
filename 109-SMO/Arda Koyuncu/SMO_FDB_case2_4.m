function [bestSolution, bestFitness, iteration]=SMO_FDB_case2_4(fhd, dimension, maxIteration, fNumber)
...
%     ValSep = cec17_func(PopSep', Funcname);
    ...
    FDBInd = fitnessDistanceBalance(Pop(1:FlockNum, :), Val(1:FlockNum))';
    % Ind = FDBInd;
    [EVal,sorted_index] = sort(Val(Ind), FDBInd);
