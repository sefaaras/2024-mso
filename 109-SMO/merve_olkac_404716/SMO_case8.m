function [bestSolution, bestFitness, iteration]=SMO_case8(fhd, dimension, maxIteration, fNumber)
...
%         WhirlingVal = cec17_func(WhirlingPop',Funcname);
    ...
    for q = 1: size(FD,2)
        ...
        % Burada fitnessDistanceBalanceIndexes fonksiyonunu kullanarak indeksleri alıyoruz
