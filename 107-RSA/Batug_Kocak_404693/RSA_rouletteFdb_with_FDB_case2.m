function [bestSolution, bestFitness, iteration]=RSA_rouletteFdb_with_FDB_case2(fhd, dimension, maxIteration, fNumber)
    config;
    LB = lbArray;
    UB = ubArray;
    Dim = dimension;
    ...
    for t = 1:Maxit  % Main loop %Update the Position of solutions
        ...
        for i = 2:size(X, 1)
            ...
            if rand < 0.5
                ...
                selected_index = fitnessDistanceBalance(X, Ffun); 
            end
