function [bestSolution, bestFitness, iteration]=CO_FDBI_Case5_3(fhd, dimension, maxIteration, fNumber)
        ...
        while FEs <= MaxIt % Algorithm 1, L#8
            ...
            for k = 1 : m % Algorithm 1, L#10
                ...
                for j = xd % select arbitrary set of arrangements
                    ...
                    beta = X1(fitnessDistanceBalance( pop , BestSol.Cost))-X(fitnessDistanceBalance( pop , BestSol.Cost));     % Interaction factor, Equation (3)
