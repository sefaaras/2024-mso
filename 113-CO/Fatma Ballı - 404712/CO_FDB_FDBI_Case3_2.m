function [bestSolution, bestFitness, iteration]=CO_FDB_FDBI_Case3_2(fhd, dimension, maxIteration, fNumber)
...
%             pop(i).Cost = fobj(pop(i).Position);
        ...
        while FEs <= MaxIt % Algorithm 1, L#8
            ...
            for k = 1 : m % Algorithm 1, L#10
                ...
                X1 = pop(fitnessDistanceBalance( pop , BestSol.Cost)).Position;   % The neighbor position                
