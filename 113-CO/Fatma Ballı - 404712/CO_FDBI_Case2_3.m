function [bestSolution, bestFitness, iteration]=CO_FDBI_Case2_3(fhd, dimension, maxIteration, fNumber)
...
%             pop(i).Cost = fobj(pop(i).Position);
        ...
        while FEs <= MaxIt % Algorithm 1, L#8
            ...
            for k = 1 : m % Algorithm 1, L#10
                ...
                X = pop(fitnessDistanceBalanceIndexes( pop , BestSol.Cost)).Position;    % The current position of i-th cheetah

                X1 = pop(fitnessDistanceBalanceIndexes( pop , BestSol.Cost)).Position;   % The neighbor position
