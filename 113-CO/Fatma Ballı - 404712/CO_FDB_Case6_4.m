function [bestSolution, bestFitness, iteration]=CO_FDB_Case6_4(fhd, dimension, maxIteration, fNumber)
...
%             pop(i).Cost = fobj(pop(i).Position);
        ...
        while FEs <= MaxIt % Algorithm 1, L#8
            ...
            for k = 1 : m % Algorithm 1, L#10
                ...
                X = pop(i).Position;    % The current position of i-th cheetah  %% X: i'inci elemanın pozisyonunu tutar.

                X1 = pop(a).Position;   % The neighbor position   %% X1: a komşusunun pozisyonunu tutar.
