function [bestSolution, bestFitness, iteration]=koa_case5(fhd, dimension, maxIteration, fNumber)
 ...
 for i=1:SearchAgents_no
    ...
    if rand<rand
        ...
        % A flag to opposite or leave the search direction of the current planet
         if fitnessDistanceBalance(Positions, PL_Fit)<0.5 %% Eq.(18)  %%değişim burada rand vardı
           f=1;
         else
           f=-1;
         end
