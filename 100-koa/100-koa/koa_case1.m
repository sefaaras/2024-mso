function [bestSolution, bestFitness, iteration]=koa_case1(fhd, dimension, maxIteration, fNumber)
...
while t<Tmax %% Termination condition  
 ...
 for i=1:SearchAgents_no
    ...
    b = fitnessDistanceBalance(Positions, PL_Fit);     %% değişim burada bu satır tamamen eklendi
