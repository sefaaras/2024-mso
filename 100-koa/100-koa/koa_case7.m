function [bestSolution, bestFitness, iteration]=koa_case7(fhd, dimension, maxIteration, fNumber)
...
while t<Tmax %% Termination condition  
 ...
 for i=1:SearchAgents_no
    ...
    if fitnessDistanceBalance(Positions, PL_Fit)<rand %%rand vardı değişim burada
