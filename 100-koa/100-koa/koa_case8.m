function [bestSolution, bestFitness, iteration]=koa_case8(fhd, dimension, maxIteration, fNumber)
...
while t<Tmax %% Termination condition  
 ...
 for i=1:SearchAgents_no
    ...
    if rand<fitnessDistanceBalance(Positions, PL_Fit) %%değişim burada rand vardı
